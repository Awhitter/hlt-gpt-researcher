...
- `tool:gpt-researcher.quick-search` — cited web research (live at `gpt-researcher-api-production.up.railway.app`).
...
- **https://gpt-researcher-api-production.up.railway.app** (200 on `/health`) — web UI + `POST /api/quick_search`, `POST /report/`.
- **https://gpt-researcher-mcp-production.up.railway.app** (200 on `/health`) — MCP server: `deep_research`, `quick_search`.
