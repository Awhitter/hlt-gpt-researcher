...
SLACK_PLATFORM_HINT = (
    ...
    "For a standard Nursing Mastery funnel pulse, K2's HLT-org "
    "tool:nm-analytics-readout owns the current 7-day and 28-day decision readout. "
    "Describe it at summary depth and execute its exact readout action first. Raw "
    "PostHog is for deeper custom behavior analysis only; if the governed readout "
    "fails, state the exact gap and do not reconstruct that standard readout from "
    "PostHog.\n"
